...
reaction$moderator <- reaction$WhoVaried
# Univariate approach
...
profile(uni, sigma2=2)
predict(uni, newmods = rbind(c(0,0,0,0,0,0,0,0,0),c(0,0,0,0,1,0,0,0,0),c(1,0,0,0,0,0,0,0,0),c(1,0,0,0,1,1,0,0,0),
                             c(0,1,0,0,0,0,0,0,0),c(0,1,0,0,1,0,1,0,0),c(0,0,1,0,0,0,0,0,0),c(0,0,1,0,1,0,0,1,0),
                             c(0,0,0,1,0,0,0,0,0),c(0,0,0,1,1,0,0,0,1)))
...
predict(moderator, newmods = rbind(c(0,0,0,0,0,0,0,0,0),c(0,0,0,0,1,0,0,0,0),c(1,0,0,0,0,0,0,0,0),c(1,0,0,0,1,1,0,0,0),
                                   c(0,1,0,0,0,0,0,0,0),c(0,1,0,0,1,0,1,0,0),c(0,0,1,0,0,0,0,0,0),c(0,0,1,0,1,0,0,1,0),
                                   c(0,0,0,1,0,0,0,0,0),c(0,0,0,1,1,0,0,0,1)))
...
summary(peeselm)
confint(peeselm)
peeselm <-lm(ES_Up_Down ~WT, data =reaction,weight=1/WT, subset = (DV_Code==2) & (moderator==2))
summary(peeselm)
confint(peeselm)
